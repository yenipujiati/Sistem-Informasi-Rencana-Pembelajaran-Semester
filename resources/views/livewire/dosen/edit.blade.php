                            ...
                            <div class="card-body">
                                @foreach($pertemuan as $index =>$item)
                                    <div class="border p-3 mb-3">
                                        <div class="form-group">
                                            <select id="istest{{$index}}" class="form-control @error('pertemuan.'.$index.'.istest') is-invalid @enderror" name="istest" required wire:model.defer="pertemuan.{{$index}}.istest">
                                                {{-- <option selected>Apakah sedang minggu ujian?</option> --}}
                                                <option value="UTS">UTS</option>
                                                <option value="UAS">UAS</option>
                                                <option value="Bukan minggu ujian">Bukan minggu ujian</option>
                                            </select>
                                            @error('pertemuan.'.$index.'.istest')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                            @enderror
